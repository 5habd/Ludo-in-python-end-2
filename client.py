...
def leftBoard():
    ...
    for box in range(0,11):
        if(box == 0):
            boxLabel = Label(gameWindow, font=("Helvetica",30), width=2, height=1, relief='ridge', borderwidth=5, bg="red")
            boxLabel.place(x=xPos, y=screen_height/2 - 88)
            leftBoxes.append(boxLabel)
            xPos +=50
        else:
            boxLabel = Label(gameWindow, font=("Helvetica",55), width=2, height=1, relief='ridge', borderwidth=5, bg="white")
...
def rightBoard():
    ...
    for box in range(0,11):
        if(box == 10):
            boxLabel = Label(gameWindow, font=("Helvetica",30), width=2, height=1, relief='ridge', borderwidth=5, bg="yellow")
            boxLabel.place(x=xPos, y=screen_height/2-88)
...
def finishingBox():
    ...
    finishingBox.place(x=screen_width/2 -490, y=screen_height/2 -160)
